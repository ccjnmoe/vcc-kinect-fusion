...
/// Kinect Sensor resources
KinectSensor g_pKimectSensor;
...
int WINAPI wWinMain( HINSTANCE hInstance, HINSTANCE hPrevInstance, LPWSTR lpCmdLine, int nCmdShow )
{
    ...
    DXUTCreateWindow( L"MyKinectFusion" );
...
void InitApp()
{
	...
	HRESULT hr = g_pKimectSensor.CreateFirstConnected();
	if ( FAILED(hr) )
	{
		MessageBox(NULL, L"No Kinect sensor found!", L"ERROR!", MB_ICONHAND| MB_OK);
	}
...
int WINAPI wWinMain( HINSTANCE hInstance, HINSTANCE hPrevInstance, LPWSTR lpCmdLine, int nCmdShow )
{
	...
	if ( SUCCEEDED(hr))
	{
		MessageBox(NULL, L"Kinect found!", L"Congratulation!", MB_ICONINFORMATION | MB_OK);
		return 0;
	}
	else
	{
		MessageBox(NULL, L"No Kinect found!", L"ERROR", MB_ICONHAND | MB_OK);
		return 0;
	}
	system("pause");
	return 0;
